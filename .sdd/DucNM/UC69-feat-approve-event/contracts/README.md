# API Contracts: Approve Event (UC69)
...
This directory contains the API contracts for the UC69 feature.

### Contracts

| File | Description |
|------|-------------|
| [api-approve-event.md](api-approve-event.md) | `PATCH /api/v1/events/:id/approve` — Approve a pending event |
