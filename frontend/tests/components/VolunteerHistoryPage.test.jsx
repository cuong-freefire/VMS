...
import VolunteerHistoryPage from "../../src/components/pages/profile/VolunteerHistoryPage";
...
jest.mock("../../src/hooks/useVolunteerHistory", () => ({
  __esModule: true,
  default: jest.fn(),
}));

const useVolunteerHistory =
  require("../../src/hooks/useVolunteerHistory").default;
