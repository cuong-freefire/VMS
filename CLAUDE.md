...
This project is indexed by GitNexus as **VMS** (1110 symbols, 1914 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
